...
namespace CosmonovaRnD\Adapters\Tests\Money;

use CosmonovaRnD\Facades\Money\DTO\ActiveRate;
use CosmonovaRnD\Facades\Money\DTO\Rate;
use CosmonovaRnD\Facades\Money\DTO\Subscriber;
use CosmonovaRnD\Facades\Money\MoneyException;
use CosmonovaRnD\Facades\Money\MoneyFacade;
 ...
 * @package CosmonovaRnD\Adapters\Tests\Money
...
class MoneyFacadeTest extends TestCase
{
    ...
    /**
     * @throws \CosmonovaRnD\Facades\Money\MoneyException
    ...
    public function testSuccessResponseFromCurrencyConverter()
    {
        ...
        foreach ($dataset as $data) {
            ...
            $this->assertInstanceOf(\CosmonovaRnD\Facades\Money\DTO\ConverterResult::class, $converterResponse);
